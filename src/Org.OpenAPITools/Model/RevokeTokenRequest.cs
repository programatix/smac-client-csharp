...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class RevokeTokenRequest : IEquatable<RevokeTokenRequest>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="RevokeTokenRequest" /> class.
        /// </summary>
        /// <param name="token">The access token to revoke (required).</param>
        public RevokeTokenRequest(string token = default(string))
        {
            // to ensure "token" is required (not null)
            if (token == null)
            {
                throw new ArgumentNullException("token is a required property for RevokeTokenRequest and cannot be null");
            }
            this.Token = token;
        }
        ...
        /// </summary>
        /// <value>The access token to revoke</value>
        ...
        {
            return this.Equals(input as RevokeTokenRequest);
        }

        /// <summary>
        /// Returns true if RevokeTokenRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of RevokeTokenRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RevokeTokenRequest input)
        {
            if (input == null)
            {
                return false;
